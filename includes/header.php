    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0 pe-4">
                ...
                <a href="#about" class="nav-item nav-link <?php if($currentPage == 'about.php') echo 'active'; ?>">Sobre Nosotros</a>
                <a href="#servicio" class="nav-item nav-link <?php if($currentPage == 'service.php') echo 'active'; ?>">Servicios</a>
                <a href="#menu" class="nav-item nav-link <?php if($currentPage == 'menu.php') echo 'active'; ?>">Menú</a>
            ...
            <a href="#reserva" class="btn btn-primary py-2 px-4">Reservar</a>
        </div>
    </nav>
</div>
<!-- Navbar End -->
