                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">Boletín de
                            Noticias</h4>
                        <p>¡Cuéntanos que opinas de nuestro Restaurante!.</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Tu Sitio Web</a>, Todos los Derechos Reservados.
                            ...
                            Distribuido por <a class="border-bottom" href="https://themewagon.com"
